...
public class staminaBar : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        exhaustedViginetteSecond = transform.Find("Exhausted Viginette (1)").gameObject;
        exhaustedViginetteSecond.transform.localScale = new Vector3(z, z, z);
    }
    ...
    void Update()
    {
        ...
        exhaustedViginetteSecond.transform.localScale = new Vector3(-(stamina / 50) - (y), -(stamina / 50) - (y), z);
    }
}
